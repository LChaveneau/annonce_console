...
import pandas as pd
import sys
sys.path.append('C:\\Users\\Lucas\\Documents\\M2\\Python\\Projet\\version_propre\\Machine_learning')
import lib_modele as lib
import numpy as np

def test_meilleur_modele():
    entree = [
        lib.Metrics(modele = "1", parametre = {}, error = .19, mse = 120., mse_tr = 45.),
        lib.Metrics(modele = "2", parametre = {}, error = .45, mse = 256., mse_tr = 45.),
        lib.Metrics(modele = "3", parametre = {}, error = .67, mse = 678., mse_tr = 45.),
        lib.Metrics(modele = "4", parametre = {}, error = .1, mse = 123., mse_tr = 45.),
        lib.Metrics(modele = "5", parametre = {}, error = .6, mse = 456., mse_tr = 45.)
    ]
