...
import pandas as pd
import sys
sys.path.append('C:\\Users\\Lucas\\Documents\\M2\\Python\\Projet\\version_propre\\Nettoyage_données')
import lib_nettoyage as lib

PATH_TO_FILE = r"C:\Users\Lucas\Documents\M2\Python\Projet\version_propre"

COLUMNS = ['id', 'titre', 'prix', 'deli_price', 'etat', 'couleur', 'retour',
           'type', 'code_region', 'connectivite', 'resolution', 'marque',
           'plateforme', 'memoire', 'modele', 'set_desc']
...
def supprime_doublons():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = columns).equals( lib.supprime_doublons(pd.DataFrame(data = rows_entree, columns = COLUMNS)))
...
def test_traite_prix1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals( lib.traite_prix(pd.DataFrame(data = rows_entree, columns = COLUMNS)))
...
def test_traite_deli_price1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals( lib.traite_deli_price(pd.DataFrame(data = rows_entree, columns = COLUMNS)))
...
def test_traite_retour1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals( lib.traite_retour(pd.DataFrame(data = rows_entree, columns = COLUMNS)))
...
def traite_etat1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals( lib.traite_etat(pd.DataFrame(data = rows_entree, columns = COLUMNS)))
...
def test_anomalie_type1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals( lib._anomalie_type_(pd.DataFrame(data = rows_entree, columns = COLUMNS), PATH_TO_FILE))
...
def test_anomalie_type3():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals( lib._anomalie_type_(pd.DataFrame(data = rows_entree, columns = COLUMNS), PATH_TO_FILE).sort_index())  
...
def test_anomalie_plateforme1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals( lib._anomalie_plateforme_(pd.DataFrame(data = rows_entree, columns = COLUMNS), PATH_TO_FILE))
...
def test_anomalie_plateforme3():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals(lib._anomalie_plateforme_(pd.DataFrame(data = rows_entree, columns = COLUMNS), PATH_TO_FILE).sort_index())
...
def test_anomalie_marque1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals( lib._anomalie_marque_(pd.DataFrame(data = rows_entree, columns = COLUMNS), PATH_TO_FILE))
...
def test_anomalie_marque3():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals( lib._anomalie_marque_(pd.DataFrame(data = rows_entree, columns = COLUMNS), PATH_TO_FILE).sort_index())
...
def test_anomalie_modele1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals( lib._anomalie_modele_(pd.DataFrame(data = rows_entree, columns = COLUMNS), PATH_TO_FILE))
...
def test_anomalie_marque3():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals( lib._anomalie_modele_(pd.DataFrame(data = rows_entree, columns = COLUMNS), PATH_TO_FILE).sort_index())
...
def test_autre_anomalie1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS).equals( lib._autre_anomalie_(pd.DataFrame(data = rows_entree, columns = COLUMNS)))
...
def test_var_console1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS+['console']).equals(lib.var_console(pd.DataFrame(data = rows_entree, columns = COLUMNS), PATH_TO_FILE))
...
def test_var_manette1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS + ['manette']).equals(lib.var_manette(pd.DataFrame(data = rows_entree, columns = COLUMNS)))
...
def test_var_cable1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS + ['cable']).equals(lib.var_cable(pd.DataFrame(data = rows_entree, columns = COLUMNS)))
...
def test_var_nbjeu1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS + ['nbjeu']).equals(lib.var_jeu(pd.DataFrame(data = rows_entree, columns = COLUMNS)))
...
def test_var_edition1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS + ['edition']).equals(lib.var_edition(pd.DataFrame(data = rows_entree, columns = COLUMNS), PATH_TO_FILE))
...
def test_traite_memoire():
    assert lib._traite_memoire_('3go') == 3.
    assert lib._traite_memoire_('56go') == 56.
    assert lib._traite_memoire_('3to') == 3000.
...
def test_var_memoire1():
    ...
    assert pd.DataFrame(data = rows_attendu, columns = COLUMNS + ['console']).equals(lib.var_memoire(pd.DataFrame(data = rows_entree, columns = COLUMNS + ['console'])))
    
def test_supprime_variable():
    column_before = ["id", 	"titre", "prix", "deli_price", "etat", "couleur", "retour",	"type", "code_region", "connectivite", "resolution", "marque", "plateforme", "memoire", "modele", "set_desc", "console", "manette", "cable", "jeu", "edition"]
    column_after = ["prix", "deli_price", "etat", "retour",	"memoire", "console", "manette", "cable", "jeu", "edition"]
    assert lib.supprime_variables(pd.DataFrame(columns = column_before)).equals(pd.DataFrame(columns = column_after))